...
class SesliAsistan:
    ...
    def ses_karslik(self,gelen_Ses):
        if(gelen_Ses in "programı kapat"):
           ...
           exit()
        elif(gelen_Ses in "raporlamayı başlat"):
            ...
            try:
             ...
             #Kelime sayımlarını al
                ...
                self.seslendirme("buraya kadar sorunsuz çalıstı 1")
                ...
                self.seslendirme("buraya kadar sorunsuz çalıstı 2")
                
                def raporu_doldur(file_path, comparison_results):
                    doc = Document(file_path)
                    self.seslendirme("buraya kadar sorunsuz çalıstı 3")
                    placeholders = {
                        "Şirket Adı": "………………..",
                        "Raporlama Tarihi": "..../.…/.…",
                        "Kontrol Saatleri": "..:.. / …:…",
                    ...
                    self.seslendirme("buraya kadar sorunsuz çalıstı 4")
